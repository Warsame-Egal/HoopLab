...
class ApiConfig:
    def __init__(self):
        # nba-scoreboard uses NBA_API_PROXY; HoopLab also accepts NBA_API_CONFIG
        config_env = os.getenv("NBA_API_CONFIG") or os.getenv("NBA_API_PROXY") or ""
...
def get_api_kwargs() -> dict:
    """Keyword args for nba_api endpoints (proxy rotation), same as nba-scoreboard."""
